...
export async function POST(request: Request) {
    try {
        ...
        const file = form.get("financeFile") as File;
        ...
        const financeUploadTimeCol = mapping.fields.find(f => f.key === "finance-upload-time")!.column;
        ...
        await sheets.spreadsheets.values.batchUpdate({
            ...
            requestBody: {
                ...
                data: [
                    {
                        range: `Sheet1!${financeUploadedByCol}${rowNum}`,
                        values: [[submittedBy]],
                    },
                    {
                        range: `Sheet1!${financeUploadTimeCol}${rowNum}`,
                        values: [[currentTime]],
                    },
                ],
            },
