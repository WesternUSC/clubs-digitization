...
export default function CertificatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch("/api/log-coi-ai", {
      method: "POST",
    ...
    <div className="space-y-6">
      ...
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Additionally Insured</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      {/* Page Header Section */}
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Upload Additionally Insured COI</h1>
