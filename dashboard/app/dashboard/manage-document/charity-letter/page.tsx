...
export default function CertifcateDashboardPage() {
    const documentTypes = [
        // New card for Finding a COI:
        {
            ...
            href: "/dashboard/manage-document/charity-letter/find",
            bgColor: "bg-blue-100",
            iconColor: "text-blue-600",
        },
        {
            title: "Upload Charity Letter",
            description: "Upload and verify certificate documents",
            icon: Upload,
            href: "/dashboard/manage-document/charity-letter/upload",
        ...
        <div className="space-y-6">
            ...
            <Breadcrumb className="mb-6">
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <BreadcrumbPage>Charity Letter</BreadcrumbPage>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            ...
            <div>
                <h1 className="text-3xl font-bold tracking-tight">Charity Letter</h1>
