...
export default function CertifcateDashboardPage() {
  ...
  const documentTypes = [
    // New card for Finding a COI:
    {
      ...
      href: "/dashboard/manage-document/purchase-order/find",
      bgColor: "bg-blue-100",
    ...
    },
    {
      ...
      icon: Upload,
      href: "/dashboard/manage-document/purchase-order/upload",
      bgColor: "bg-green-100",  // background color for upload card
      iconColor: "text-green-600", // icon color for upload card
    },
    {
      title: "Attach Invoice to PO",
      description: "Upload and verify certificate documents",
      icon: FilePlus2,
      href: "/dashboard/manage-document/purchase-order/attach-invoice",
      bgColor: "bg-orange-100",  // background color for upload card
      iconColor: "text-orange-600", // icon color for upload card
    },
    {
      title: "Set PO Payment Status",
      description: "Upload and verify certificate documents",
      icon: DollarSign,
      href: "/dashboard/manage-document/purchase-order/update-status",
      bgColor: "bg-rose-100",  // background color for upload card
      iconColor: "text-rose-600", // icon color for upload card
    },
