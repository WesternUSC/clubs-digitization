...
export default function CertificatePage() {
  ...
  const [financeFile, setFinanceFile] = useState<File>()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch("/api/log-sponsor", {
      method: "POST",
    ...
    <div className="space-y-6">
      ...
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Upload Sponsorship</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      {/* Page Header Section */}
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Upload Sponsorship</h1>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="document-upload">Upload Sponsorship Document</Label>
              <Input
                id="document-upload"
                type="file"
            ...
            {/* Conditional Invoice Upload & Paid? */}
              <div className="space-y-4 border rounded-md p-4 bg-muted/10">
                ...
                <div className="space-y-2">
                  ...
                  />
                  {contractFile && (
                    <p className="text-sm text-muted-foreground">Selected invoice: {contractFile.name}</p>
                  )}
                </div>

                                {/* Finance File Upload */}
                                <div className="space-y-2">
                  <Label htmlFor="finance-upload">Upload Finance</Label>
                  <Input
                    id="finance-upload"
                    type="file"
                  ...
                  />
                  {financeFile && (
                    <p className="text-sm text-muted-foreground">Selected invoice: {financeFile.name}</p>
                  )}
                </div>
